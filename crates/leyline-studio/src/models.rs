...
pub(crate) fn dev_model(settings: &Settings) -> crate::ui::DevSettings {
    ...
    crate::ui::DevSettings {
        ...
        sharpen_masking: settings.sharpening.masking as f32,
        ...
        grain_color: settings.grain.color as f32,
    ...
    settings
        ...
        .map(|entry| {
            ...
            let mut row = crate::ui::MaskRow {
                ...
                clarity: values.clarity.unwrap_or(0) as f32,
                texture: values.texture.unwrap_or(0) as f32,
