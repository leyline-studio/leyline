...
mod tests {
    ...
    fn disabled_lens_correction_matches_process_3_bit_for_bit() {
        ...
        let with_process_3 =
            crate::process3::develop_scaled(&image, &settings, Some(&canon_shot(20.0)), 1.0)
                .unwrap();
    ...
    fn no_aperture_skips_vignetting_but_keeps_distortion() {
        ...
        let out3 =
            crate::process3::develop_scaled(&image, &enabled_settings(), Some(&shot), 1.0).unwrap();
        assert_eq!(out4, out3);
    }
    ...
    fn vignetting_further_changes_the_distortion_only_process_3_render() {
        ...
        let out3 = crate::process3::develop_scaled(
            &image,
            &enabled_settings(),
