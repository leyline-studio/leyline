//! Lens correction v3 (ADR 0018) — rank 20. Distortion, TCA, vignetting.
//!
//! Introduced by process 5 and current since. TCA runs as its own resampling
//! pass between the two, on the buffer `undistort` produced; both geometric
//! passes share one built [`leyline_lens::Correction`].
//!
